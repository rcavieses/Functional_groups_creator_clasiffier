"""
Validar Especies por Grupo — Vista Detallada

Interfaz alternativa para validar especies individuales dentro de cada grupo
(Funcionalidad anterior, mantiene compatibilidad)
"""
...
st.set_page_config(page_title="Validar Especies", page_icon="✅", layout="wide")
